...
def approve(task_uuid):
    ...
    app.extensions['celery'].send_task('scribe.tasks.send_summary', [
                                       res_dict['user_email'], res_dict['user_filename'], res_dict['summary_filename'], res_dict['transcript_filename']])
