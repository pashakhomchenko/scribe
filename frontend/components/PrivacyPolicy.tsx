...
export default function PrivacyPolicy() {
  return (
    <div className="flex p-8 md:p-16 flex-col gap-6">
      <Heading className="self-center">Privacy Policy</Heading>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Scribe.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Scribe, accessible from{' '}
            <a
              href="tryscribeai.com"
      ...
      <ul>
        <li>By email: tryscribeai@gmail.com</li>
      </ul>
    </div>
  );
}
