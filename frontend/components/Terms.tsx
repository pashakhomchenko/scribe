...
export default function Terms() {
  return (
    <div className="flex p-8 md:p-16 flex-col gap-6">
      TERMS OF SERVICE ---- OVERVIEW This website is operated by Scribe.
      Throughout the site, the terms “we”, “us” and “our” refer to Scribe.
      Scribe offers this website, including all information, tools and Services
      ...
      constitutes acceptance of those changes. Our store is hosted on Shopify
      Inc. They provide us with the online e-commerce platform that allows us to
      sell our products and Services to you. SECTION 1 - ONLINE STORE TERMS By
      ...
      only and will not limit or otherwise affect these Terms. SECTION 3 -
      ...
      only according to our Return Policy. To view our Return Policy, please
      ...
      at the store. We cannot guarantee that your computer monitor's display of
      any color will be accurate. We reserve the right, but are not obligated,
      to limit the sales of our products or Services to any person, geographic
      ...
      us. We reserve the right to discontinue any product at any time. Any offer
      for any product or service made on this site is void where prohibited. We
      ...
      or that any errors in the Service will be corrected. SECTION 6 - ACCURACY
      ...
      Returns Policy. SECTION 7 - OPTIONAL TOOLS We may provide you with access
      to third-party tools over which we neither monitor nor have any control
      nor input. You acknowledge and agree that we provide access to such tools
      ...
      third-party tools. Any use by you of the optional tools offered through
      the site is entirely at your own risk and discretion and you should ensure
      ...
      LINKS Certain content, products and Services available via our Service may
      ...
      directed to the third-party. SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER
      ...
      SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS Occasionally there may be
      ...
      case shall Scribe, our directors, officers, employees, affiliates, agents,
      ...
      agree to indemnify, defend and hold harmless Scribe and our parent,
      ...
      tryscribeai@gmail.com. Our contact information is posted below: [INSERT
